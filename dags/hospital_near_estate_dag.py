...
def extractAllEstate(**context):
    ...
    sql = """
        SELECT articleno, longitude, latitude FROM raw_data.real_estate;
        """
...
def extractUniqueEstate(**context):
    ...
    new_estate_sql = """
    SELECT A.articleno, A.longitude, A.latitude FROM raw_data.real_estate AS A
...
[hospital_transform_task_1, hospital_transform_task_2, hospital_transform_task_3, hospital_transform_task_4, hospital_transform_task_5, hospital_transform_task_6] >> combine_all_data_task
