...
FILE_NAME = "kindergarden_near_estate.csv"
...
dag = DAG(
    dag_id='kindergarden_near_estate_dag',
...
CREATE TABLE IF NOT EXISTS raw_data.kindergarden_near_estate (
    ...
    y FLOAT,
    type VARCHAR(500),
    kindergarden_name_1 VARCHAR(500),
    longitude_1 FLOAT, 
    latitude_1 FLOAT,
    kindergarden_name_2 VARCHAR(500),
    longitude_2 FLOAT, 
    latitude_2 FLOAT,
    kindergarden_name_3 VARCHAR(500),
    longitude_3 FLOAT, 
    latitude_3 FLOAT
);
"""
...
def getDataCount(**context):
    ...
    sql = """
    SELECT COUNT(*) FROM raw_data.kindergarden_near_estate;
    """
...
def kindergarden_extract(**context):
   redshift_hook = RedshiftSQLHook(redshift_conn_id='rs_conn')
    
   sql = """
    SELECT kindergarden_name, longitude, latitude
    FROM analytics.seoul_kindergarden
    """
   ...
   context["ti"].xcom_push(key="kindergarden_extracted_data", value=rows)


def kindergarden_transform_1(**context):
    kindergarden_extracted_list = context["ti"].xcom_pull(key="kindergarden_extracted_data")
    ...
    for index_1, row_1 in address_df.iterrows():
        ...
        for i in range(len(kindergarden_list)):
            kindergarden_data.append(kindergarden_list[i][0])
            kindergarden_data.append(kindergarden_list[i][1])
            kindergarden_data.append(kindergarden_list[i][2])
        kindergarden_transformed_data.append(kindergarden_data)

    context["ti"].xcom_push(key="kindergarden_transformed_data_1", value=kindergarden_transformed_data)

def kindergarden_transform_2(**context):
    kindergarden_extracted_list = context["ti"].xcom_pull(key="kindergarden_extracted_data")
    ...
    context["ti"].xcom_push(key="kindergarden_transformed_data_2", value=kindergarden_transformed_data)


def kindergarden_transform_3(**context):
    kindergarden_extracted_list = context["ti"].xcom_pull(key="kindergarden_extracted_data")
    ...
    context["ti"].xcom_push(key="kindergarden_transformed_data_3", value=kindergarden_transformed_data)


def kindergarden_transform_4(**context):
    kindergarden_extracted_list = context["ti"].xcom_pull(key="kindergarden_extracted_data")
    ...
    context["ti"].xcom_push(key="kindergarden_transformed_data_4", value=kindergarden_transformed_data)


def kindergarden_transform_5(**context):
    kindergarden_extracted_list = context["ti"].xcom_pull(key="kindergarden_extracted_data")
    ...
    context["ti"].xcom_push(key="kindergarden_transformed_data_5", value=kindergarden_transformed_data)


def kindergarden_transform_6(**context):
    kindergarden_extracted_list = context["ti"].xcom_pull(key="kindergarden_extracted_data")
    ...
    context["ti"].xcom_push(key="kindergarden_transformed_data_6", value=kindergarden_transformed_data)


def combineAllData(**context):
    transformed_data_1 = context["ti"].xcom_pull(key="kindergarden_transformed_data_1")
    transformed_data_2 = context["ti"].xcom_pull(key="kindergarden_transformed_data_2")
    transformed_data_3 = context["ti"].xcom_pull(key="kindergarden_transformed_data_3")
    transformed_data_4 = context["ti"].xcom_pull(key="kindergarden_transformed_data_4")
    transformed_data_5 = context["ti"].xcom_pull(key="kindergarden_transformed_data_5")
    transformed_data_6 = context["ti"].xcom_pull(key="kindergarden_transformed_data_6")
...
def loadToRedshift(autocommit=True):
   ...
   cursor = conn.cursor()
    ...
    # Redshift용 COPY 명령문
   copy_query = f"""
   COPY raw_data.kindergarden_near_estate
...
CreatekindergardenTable = PostgresOperator(
    task_id = "create_kindergarden_table",
...
kindergarden_extract_task = PythonOperator(
    task_id = "kindergarden_extract",
    python_callable=kindergarden_extract,
    dag=dag
)

kindergarden_transform_task_1 = PythonOperator(
    task_id = "kindergarden_transform_1",
    python_callable=kindergarden_transform_1,
    dag=dag
)

kindergarden_transform_task_2 = PythonOperator(
    task_id = "kindergarden_transform_2",
    python_callable=kindergarden_transform_2,
    dag=dag
)

kindergarden_transform_task_3 = PythonOperator(
    task_id = "kindergarden_transform_3",
    python_callable=kindergarden_transform_3,
    dag=dag
)

kindergarden_transform_task_4 = PythonOperator(
    task_id = "kindergarden_transform_4",
    python_callable=kindergarden_transform_4,
    dag=dag
)

kindergarden_transform_task_5 = PythonOperator(
    task_id = "kindergarden_transform_5",
    python_callable=kindergarden_transform_5,
    dag=dag
)

kindergarden_transform_task_6 = PythonOperator(
    task_id = "kindergarden_transform_6",
    python_callable=kindergarden_transform_6,
    dag=dag
)
