...
def load(**context):
    ...
    pg_hook = PostgresHook(postgres_conn_id="redshift_dev")
...
createCultureTable >> getCultureTotalNumber >> CultureDataExtract >> CultureDataTransform >> CultureDataLoad >> trigger_analytics_culture_dag