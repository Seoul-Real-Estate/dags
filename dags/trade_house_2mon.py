...
with DAG(
    ...
    before_fname2 = f"house_trade_{mon2}_{yesterday}.csv"
    now_fname2 = f"house_trade_{mon2}_{today}.csv"
    upload_fname2 = f"house_trade_upload_{mon2}_{today}.csv"

    raw_df2 = get_house_trade(sre2, url, key, house_trade_origin_cols, house_trade_cols)
    preproc_df2 = house_trade_preproc(sre2, raw_df2, preproc_cols)
    upload_task2 = house_trade_uploadS3(sre2, preproc_df2) 
    new_df2 = house_trade_compare(sre2, before_fname2, now_fname2, fin_cols)
    ...
    load_task2 = house_trade_new_uploadS3(new_df2, upload_fname2)
    load_redshif_task2 = house_trade_load(schema, table, upload_fname2, credential)
